        ...
        <div className="bg-white rounded-lg border border-gray-200 p-8 shadow-sm">
          <form id="registerForm" className="space-y-6">
            ...
            <div>
              ...
              placeholder="Confirm your password" className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200" />
